...
export EXP_NAME="dit_robotwin_${task_name}_${task_config}_seed${seed}_monocular_diffusion_graphormer"
export WANDB_NAME="dit_robotwin_${task_name}_${task_config}_seed${seed}_monocular_diffusion_graphormer"
