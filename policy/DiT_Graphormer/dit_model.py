...
class DiT_Graphormer:
    def __init__(self, ckpt_file: str, ac_chunk, img_chunk):
        ...
        print(f"DiT_Graphormer model loaded on device: {self.device}")
...
if __name__ == "__main__":
    # Example usage
    ckpt_file = "/scratch2/meat124/dit_ws/src/RoboTwin/policy/DiT_Graphormer/bc_finetune/dit_robotwin_stack_blocks_three_demo_clean_seed0/wandb_dit_robotwin_stack_blocks_three_demo_clean_seed0_stack_blocks_three_resnet_gn_2025-08-13_20-07-59/dit_robotwin_stack_blocks_three_demo_clean_seed0.ckpt"
    ac_chunk = 50  # Example value
    img_chunk = 3  # Example value
    model = DiT_Graphormer(ckpt_file, ac_chunk, img_chunk)
    print("DiT_Graphormer model initialized.")
