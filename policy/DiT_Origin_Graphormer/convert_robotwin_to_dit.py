...
#     model = MoGeModel.from_pretrained("/scratch2/meat124/dit_ws/src/RoboTwin/policy/DiT/visual_features/moge_model/model_vitl_normal.pt").to(device)
...
#     # 카메라 이름 순서를 명시적으로 고정
#     # camera_names = ['front_camera', 'head_camera', 'left_camera', 'right_camera']
#     camera_names = ['head_camera']  # DiT MoGe uses only head camera
