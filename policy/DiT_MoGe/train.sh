...
export EXP_NAME="dit_robotwin_${task_name}_${task_config}_seed${seed}_monocular_diffusion_moge"
export WANDB_NAME="dit_robotwin_${task_name}_${task_config}_seed${seed}_monocular_diffusion_moge"
...
export RESTORE_PATH="/scratch2/meat124/dit_ws/src/RoboTwin/policy/DiT_MoGe/visual_features/resnet18/IN_1M_resnet18.pth"
