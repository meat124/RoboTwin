...
#     """
#     RoboTwin DiT_Graphormer_V2_MoGe + depth
#     """
#     import cv2
#     import torch
...
#     model = MoGeModel.from_pretrained("/scratch2/meat124/dit_ws/src/RoboTwin/policy/DiT_Graphormer_V2_MoGe/visual_features/moge_model/model_vitl_normal.pt").to(device)
...
#     # 카메라 이름 순서를 명시적으로 고정
#     # camera_names = ['front_camera', 'head_camera', 'left_camera', 'right_camera']
#     camera_names = ['head_camera']  # DiT_Graphormer_V2_MoGe MoGe uses only head camera
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert RoboTwin HDF5 to DiT_Graphormer_V2_MoGe PKL format.")
